...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3644470610590797493, ; hash 0x3293c2b60a9d8eb5, from name: aot-AppKazanova.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 4427970598966091291, ; hash 0x3d734fcca33f5e1b, from name: aot-AppKazanova
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppKazanova.dll.so
		ptr null; void* handle (0x0)
	}, ; 112
	...
	%struct.DSOCacheEntry {
		i64 7459908068038475238, ; hash 0x6786eadd1480fde6, from name: libaot-AppKazanova
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppKazanova.dll.so
		ptr null; void* handle (0x0)
	}, ; 171
	...
	%struct.DSOCacheEntry {
		i64 11824383651788605858, ; hash 0xa418a64874cbc9a2, from name: AppKazanova
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppKazanova.dll.so
		ptr null; void* handle (0x0)
	}, ; 302
	...
	%struct.DSOCacheEntry {
		i64 12209029576709285696, ; hash 0xa96f2fb6bbfea740, from name: libaot-AppKazanova.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppKazanova.dll.so
		ptr null; void* handle (0x0)
	}, ; 313
	...
	%struct.DSOCacheEntry {
		i64 14118311521800260176, ; hash 0xc3ee5186ed358a50, from name: AppKazanova.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppKazanova.dll.so
		ptr null; void* handle (0x0)
	}, ; 370
