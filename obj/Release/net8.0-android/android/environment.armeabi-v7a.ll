...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670637, ; uint32_t jnienv_initialize_method_token (0x6001cad)
	i32 100670636, ; uint32_t jnienv_registerjninatives_method_token (0x6001cac)
...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 12062363, ; hash 0xb80e9b, from name: aot-AppKazanova.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppKazanova.dll.so
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.74_name, ; name: libaot-System.Threading.Thread.dll.so
		ptr null; void* handle (0x0)
	}, ; 4
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.73_name, ; name: libaot-System.Text.RegularExpressions.dll.so
		ptr null; void* handle (0x0)
	}, ; 24
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 347609027, ; hash 0x14b817c3, from name: AppKazanova
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppKazanova.dll.so
		ptr null; void* handle (0x0)
	}, ; 37
	...
	%struct.DSOCacheEntry {
		i64 1309763099, ; hash 0x4e11661b, from name: aot-AppKazanova
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppKazanova.dll.so
		ptr null; void* handle (0x0)
	}, ; 133
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.75_name, ; name: libaot-System.Threading.dll.so
		ptr null; void* handle (0x0)
	}, ; 148
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3183439525, ; hash 0xbdbf6ea5, from name: AppKazanova.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppKazanova.dll.so
		ptr null; void* handle (0x0)
	}, ; 367
	...
	%struct.DSOCacheEntry {
		i64 3750133241, ; hash 0xdf867df9, from name: libaot-AppKazanova.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppKazanova.dll.so
		ptr null; void* handle (0x0)
	}, ; 420
	...
	%struct.DSOCacheEntry {
		i64 3960608506, ; hash 0xec1216fa, from name: libaot-AppKazanova
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppKazanova.dll.so
		ptr null; void* handle (0x0)
	}, ; 445
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [110 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
...
@.env.3 = private unnamed_addr constant [37 x i8] c"b0212808-c00f-4e7b-a0d2-a9e2bcd49edc\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.appkazanova\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [26 x i8] c"libaot-AppKazanova.dll.so\00", align 1
...
@.DSOCacheEntry.73_name = private unnamed_addr constant [45 x i8] c"libaot-System.Text.RegularExpressions.dll.so\00", align 1
@.DSOCacheEntry.74_name = private unnamed_addr constant [38 x i8] c"libaot-System.Threading.Thread.dll.so\00", align 1
@.DSOCacheEntry.75_name = private unnamed_addr constant [31 x i8] c"libaot-System.Threading.dll.so\00", align 1
@.DSOCacheEntry.76_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 1
@.DSOCacheEntry.77_name = private unnamed_addr constant [21 x i8] c"libaot-System.dll.so\00", align 1
@.DSOCacheEntry.78_name = private unnamed_addr constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 1
@.DSOCacheEntry.79_name = private unnamed_addr constant [35 x i8] c"libaot-Mono.Android.Runtime.dll.so\00", align 1
@.DSOCacheEntry.80_name = private unnamed_addr constant [27 x i8] c"libaot-Mono.Android.dll.so\00", align 1
@.DSOCacheEntry.81_name = private unnamed_addr constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 1
